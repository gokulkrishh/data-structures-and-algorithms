/* Problem: Given a binary tree, find the lowest common ancestor (LCA) of two given nodes in the BT.
	...
	Note: According to the definition of LCA on Wikipedia: “The lowest common ancestor is defined between two nodes v and w
	as the lowest node in T that has both v and w as descendants (we can allow a node to be a descendant of itself too).”
  ...
  Example:
   ...
   0      _4       7       9
	...
	Output: the lowest common ancestor (LCA) of nodes 2 and 8 is 6.
...
var root = {
	...
	right: {
		val: 8,
		right: { left: null, val: 7, right: null },
		left: { left: null, val: 9, right: null }
	}
};
